...
export TRADE_KIND=O             # O:OPT, F:FUT
...
# 只算TXO
STOVOL_CMD="$STOVOL_CMD -t $GRPID $LLM_CONFIG_FILE $OPT_DBDATA_SQLITE $FUT_DBDATA_SQLITE $OPT_MATCH_FILE $FUT_MATCH_FILE $OPT_TPC_FILE"

# 計算STC
#STOVOL_CMD="$STOVOL_CMD  $GRPID $LLM_CONFIG_FILE $OPT_DBDATA_SQLITE $FUT_DBDATA_SQLITE $OPT_MATCH_FILE $FUT_MATCH_FILE $OPT_TPC_FILE"

#重啟
#STOVOL_CMD="$STOVOL_CMD -r $GRPID $LLM_CONFIG_FILE $OPT_DBDATA_SQLITE $FUT_DBDATA_SQLITE $OPT_MATCH_FILE $FUT_MATCH_FILE $OPT_TPC_FILE"

#啟動LLM
#STOVOL_CMD="$STOVOL_CMD -l $GRPID $LLM_CONFIG_FILE $OPT_DBDATA_SQLITE $FUT_DBDATA_SQLITE $OPT_MATCH_FILE $FUT_MATCH_FILE $OPT_TPC_FILE"

#啟動mcc
#STOVOL_CMD="$STOVOL_CMD -m $GRPID $LLM_CONFIG_FILE $OPT_DBDATA_SQLITE $FUT_DBDATA_SQLITE $OPT_MATCH_FILE $FUT_MATCH_FILE $OPT_TPC_FILE"
